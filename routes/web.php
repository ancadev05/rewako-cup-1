...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/official/peraturan-olahraga', [OfficialController::class, 'peraturanOlahraga'])->middleware('userAkses:official');
    ...
    Route::get('/official/download/data-atlet', [DownloadBerkasController::class, 'dataAtlet'])->middleware('userAkses:official');
    ...
    Route::get('/admin-kejurnas/data-fix', [AdminKejurnasController::class, 'dataFix'])->middleware('userAkses:admin-kejurnas');
    // Route::post('/admin-kejurnas/data-fix', [AdminKejurnasController::class, 'dataFix'])->middleware('userAkses:admin-kejurnas');
    Route::get('/admin-kejurnas/atlet-cari', [AdminKejurnasController::class, 'atletCari'])->middleware('userAkses:admin-kejurnas');
