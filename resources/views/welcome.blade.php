            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col">
                <div class="card shadow-sm">
                  <iframe class="bd-placeholder-img card-img-top" width="100%" height="225" src="https://www.youtube.com/embed/gbk4mgzS2x0" title="Merawat Tradisi, Kalau Bukan kita, siapa lagi?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
              </div>
              <div class="col">
                <div class="card shadow-sm">
                  <iframe class="bd-placeholder-img card-img-top" width="100%" height="225" src="https://www.youtube.com/embed/_jXA-cUARns" title="PIMDA 177 GOWA Konsisten  Mengukur dan Mengevaluasi Hasil Latihan Siswa dalam Kegiatan UKTS &amp; LKPTS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
              </div>
              <div class="col">
                <div class="card shadow-sm">
                  <iframe class="bd-placeholder-img card-img-top" width="100%" height="225" src="https://www.youtube.com/embed/Z2_3ZH8fuDI" title="Keseruan Ujian Kenaikan Tingkat Siwa TSPM PIMDA 177 GOWA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-12 footer-info">
          ...
          <div class="social-links d-flex mt-4">
            <a href="https://www.instagram.com/pimda177gowa?igsh=cjg4OTAweDQ2dHpt" class="instagram"><i class="bi bi-instagram"></i></a>
            <a href="https://www.youtube.com/@pimdatspm177gowa7" class="youtube"><i class="bi bi-youtube"></i></a>
